...
const systems = [
  {
    id: "realtime",
    title: "Realtime AI",
    description: "Ultra-low latency speech-to-speech with interruption handling.",
    icon: RadioTower
  },
  {
    id: "modular",
    title: "Modular Pipeline",
    description: "Observable STT, GPT, and TTS orchestration for debugging and analytics.",
    icon: Workflow
  }
];
      ...
      {systems.map((system) => {
        ...
        return (
          <button
            ...
            className={cn(
              "group rounded-2xl border p-4 text-left transition duration-200 hover:-translate-y-0.5 hover:border-primary/50",
              active
          ...
          >
            <div className="flex items-start gap-3">
              <div className={cn("rounded-xl p-2.5 transition", active ? "bg-primary/12 text-primary" : "bg-muted text-muted-foreground group-hover:text-primary")}>
